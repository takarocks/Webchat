...
const Header = ({ closeWebchat, preferences, logoStyle, getTranscript }) => (
  <div
  ...
  >
    ...
    <div className="RecastAppHeader--action CaiAppHeader--action" onClick={getTranscript}>Transcript</div>
